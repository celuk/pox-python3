...
class Firewall (EventMixin):
    ...
    def pushRuleToSwitch (self, src, dst, ip_proto, app_proto, duration):
        ...
        msg = of.ofp_flow_mod()
        msg.priority = 20
        msg.actions.append(of.ofp_action_output(port=0))#of.OFPP_NONE))
    ...
    def _handle_ConnectionUp (self, event):
        ...
        self.addFirewallRule('10.0.0.2', '10.0.0.3', 'icmp', 'any', 10000000)
        self.addFirewallRule('10.0.0.2', '10.0.0.5', 'icmp', 'any', 10000000)
        self.addFirewallRule('10.0.0.2', '10.0.0.4', 'icmp', 'any', 10000)
